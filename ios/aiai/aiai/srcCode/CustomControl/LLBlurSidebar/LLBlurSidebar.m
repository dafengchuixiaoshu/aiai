...
- (void)beginShowSidebar
{
    ...
    if (self.contentView.frame.origin.x < 0) { //self.blurView.alpha < 0.5 &&
        ...
        dispatch_async(queue, ^ {
            ...
            UIImage *blurImage = [self blurryImage:bself.snapImageView.image withBlurLevel:0.1];
...
- (void)setBgR:(CGFloat)r G:(CGFloat)g B:(CGFloat)b
{
    red = r/255.0;
    green = g/255.0;
    blue = b/255.0;
