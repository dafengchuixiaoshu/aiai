...
- (void)albumsViewController:(TSAlbumsViewController *)albumsVC didSelectItemFilePath:(NSString *)filePath VideoTime:(NSNumber*)time{
    [self.delegate assetsPickerController:self didSelectItemFilePath:filePath VideoTime:time];
}
