...
- (void)assetsViewController:(TSAssetsViewController *)albumsVC didSelectItemFilePath:(NSString *)filePath VideoTime:(NSNumber*)time{
    [self.delegate albumsViewController:self didSelectItemFilePath:filePath VideoTime:time];
}
