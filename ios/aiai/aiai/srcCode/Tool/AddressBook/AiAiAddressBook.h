...
typedef void (^GetContactDic)(NSDictionary *resultDic);

@interface AiAiAddressBook : NSObject<MFMessageComposeViewControllerDelegate,ABPeoplePickerNavigationControllerDelegate>
{
