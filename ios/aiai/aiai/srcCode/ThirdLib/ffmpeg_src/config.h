...
#define FFMPEG_CONFIGURATION "--enable-gpl --enable-version3 --enable-nonfree --disable-shared --enable-runtime-cpudetect --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-avresample --disable-network --disable-encoders --enable-encoder=png --enable-encoder=jpg --enable-encoder=mjpeg --enable-encoder=gif --enable-encoder=jpeg2000 --enable-encoder=bmp --enable-libx264 --enable-encoder=libx264 --enable-libfaac --enable-encoder=libfaac --disable-decoders --enable-decoder=png --enable-decoder=jpg --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=ac3 --enable-decoder=h263 --enable-decoder=h263i --enable-decoder=h263p --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=vc1 --enable-decoder=mjpeg --enable-decoder=mpeg4 --enable-decoder=webp --disable-muxers --enable-muxer=mpegts --enable-muxer=mp4 --enable-muxer=image2 --enable-muxer=mjpeg --enable-muxer=image2pipe --enable-muxer=mpjpeg --enable-muxer=mpeg2video --enable-muxer=yuv4mpegpipe --disable-demuxers --enable-demuxer=aac --enable-demuxer=ac3 --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=image2 --enable-demuxer=yuv4mpegpipe --enable-demuxer=image_jpeg_pipe --enable-demuxer=m4v --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegts --enable-demuxer=mpegvideo --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=ac3 --enable-parser=h263 --enable-parser=h264 --enable-parser=mjpeg --enable-parser=png --enable-parser=bmp --enable-parser=mpegvideo --enable-bsfs --disable-bsf=mjpeg2jpeg --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=text2movsub --enable-protocols --disable-protocol=bluray --disable-protocol=ffrtmpcrypt --disable-protocol=gopher --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol=pipe --disable-protocol='rtmp*' --disable-protocol=sctp --disable-protocol=srtp --disable-devices --disable-iconv --disable-armv5te --disable-armv6 --disable-armv6t2 --enable-cross-compile --enable-hwaccels --disable-symver --disable-stripping --arch=arm64 --target-os=darwin --enable-static --disable-shared --enable-pic --enable-neon --enable-optimizations --disable-debug --enable-small --prefix=/Users/zhangyang/Downloads/ijkplayer/ios/build/ffmpeg-arm64/output --cc='xcrun -sdk iphoneos clang' --extra-cflags='-I../x264/ -I../faac/ -mthumb -arch arm64 -miphoneos-version-min=5.1.1 ' --extra-cxxflags=' -arch arm64 -miphoneos-version-min=5.1.1 ' --extra-ldflags='-L../x264/ -L../faac/ -arch arm64 -miphoneos-version-min=5.1.1 '"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2015
#define FFMPEG_DATADIR "/Users/zhangyang/Downloads/ijkplayer/ios/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/zhangyang/Downloads/ijkplayer/ios/build/ffmpeg-arm64/output/share/ffmpeg"
#define CC_IDENT "Apple LLVM version 6.1.0 (clang-602.0.49) (based on LLVM 3.6.0svn)"
