...
//        int chroma = SDL_FCC_I420;
        ...
        // init audio sink
//        IJKAudioKit* ijkAudio = [[IJKAudioKit alloc] init];
//        [ijkAudio setupAudioSession:self];
...
- (void)setFilterData:(FilterData*)filterdata{
    ijkmp_ios_set_filterdata(_mediaPlayer, filterdata.type, filterdata.isOpenVol, [filterdata.firstMoviePath UTF8String], [filterdata.secondMoviePath UTF8String], filterdata.startTime, filterdata.endTime, (int)filterdata.fps);
}
...
- (void)shutdownClose:(IJKFFMoviePlayerController *) mySelf
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:IJKMoviePlayerFilterShutdownFinishNotification object:mySelf];
}
