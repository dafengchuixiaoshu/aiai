 ...
 */
void rijndaelKeySetupEnc(unsigned int rk[/*44*/], const unsigned char cipherKey[])
{
	int i;
	unsigned int temp;
...
{
	rijndaelEncrypt((const u32*)ctx, plain, crypt);
}
...
{
	rijndaelDecrypt((const u32*)ctx, crypt, plain);
}
...
int aes_test()
{
    ...
    for(int i=0;i<10;i++)
    {
        ...
        int len = code.decrypt_cbc(dec_buf, outlen);
